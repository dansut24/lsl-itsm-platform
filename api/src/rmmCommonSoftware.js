...
export const BUSINESS_ESSENTIAL_WINGET_PACKAGES = [
  ...
  { canonicalName: 'Microsoft ODBC Driver 18 for SQL Server', packageId: 'Microsoft.msodbcsql.18', priority: 964 },
  { canonicalName: 'psqlodbc', packageId: 'PostgreSQL.psqlODBC', priority: 963 },
  { canonicalName: 'Snowflake ODBC Driver', packageId: 'Snowflake.OdbcDriver', priority: 962 },
  { canonicalName: 'Amazon Redshift ODBC Driver 64-bit', packageId: 'Amazon.Redshift.ODBC.v2', priority: 961 },
  { canonicalName: 'Amazon Athena ODBC Driver', packageId: 'Amazon.AthenaODBCDriver.2', priority: 960 },
  { canonicalName: 'PDF-XChange Editor', packageId: 'TrackerSoftware.PDF-XChangeEditor', priority: 959 },
