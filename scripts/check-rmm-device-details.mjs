...
expect(agentApi.includes('mergeRetainedDeepInventory') && agentApi.includes("incomingPayload?.deep_inventory_included !== false"), 'Lightweight inventory snapshots must retain the last known deep endpoint intelligence on the server.')
