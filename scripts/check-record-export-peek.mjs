...
const requirements = [
  ...
  [finalCss, 'background: var(--surface, #ffffff) !important', 'Peek must use the tenant surface with a safe portal fallback rather than translucent grey.'],
  [finalCss, 'body[data-hi5-surface=\'workspace\']', 'Body-level workspace theme fallback is missing for portalled surfaces.'],
