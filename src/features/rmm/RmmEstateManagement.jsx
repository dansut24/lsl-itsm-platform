...
function SiteModal({ onClose, onSave }) {
  const [form, setForm] = useState({ name: '', code: '', type: 'Office', location: '', timeZone: 'Europe/London', monitoringPolicy: 'Standard Windows endpoint', patchRing: 'Production endpoints', maintenanceWindow: 'Wed 22:00–02:00' })
